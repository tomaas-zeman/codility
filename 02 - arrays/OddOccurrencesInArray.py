...
# and each element of the array can be paired with another element that has the same value, except for one element that
# is left unpaired.
#
...
def solution(A):
    ...
    for n in A:
        ...
        if current_value is not None:
            ...
            pairing[n] = 1
    return list(pairing.keys())[0]


test([[[9, 3, 9, 3, 9, 7, 9]]], [7], solution)
